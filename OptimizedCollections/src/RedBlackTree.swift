...
extension RedBlackTree {
    ...
    public func _inserting(_ element: Element) -> (tree: RedBlackTree, old: Element?) {
        switch self {
        case .empty:
...
extension RedBlackTree: BidirectionalCollection {
    ...
    public func fromIndex(after i: inout Index) {
...
extension RedBlackTree {
    public func fromIndex(before i: inout Index) {
