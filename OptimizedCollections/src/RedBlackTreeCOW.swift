...
public struct RedBlackTreeCOW<Element: Comparable>: SortedSet {
    fileprivate var root: Node? = nil
    
    public init() {}
    
    private func diagram<Element: Comparable>(for node: RedBlackTreeCOW<Element>.Node?, _ top: String = "", _ root: String = "", _ bottom: String = "") -> String {
...
extension RedBlackTreeCOW.Node {
...
extension RedBlackTreeCOW: CustomStringConvertible {
...
extension RedBlackTreeCOW.Node {
    ...
    func makeLeftUnique() -> RedBlackTreeCOW<Element>.Node? {
    ...
    func makeRightUnique() -> RedBlackTreeCOW<Element>.Node? {
...
extension RedBlackTreeCOW.Index {
    
    fileprivate func isValid(for root: RedBlackTreeCOW<Element>.Node?) -> Bool {
...
extension RedBlackTreeCOW.Index {
    ...
    fileprivate static func validate(_ left: RedBlackTreeCOW<Element>.Index, _ right: RedBlackTreeCOW<Element>.Index) -> Bool {
...
extension RedBlackTreeCOW.Index {
    ...
    fileprivate var current: RedBlackTreeCOW<Element>.Node? {
        guard let ref = path.last else { return nil }
        return ref.value!
    }
}

extension RedBlackTreeCOW.Index: Comparable {
    
    public static func ==(left: RedBlackTreeCOW<Element>.Index, right: RedBlackTreeCOW<Element>.Index) -> Bool {
        precondition(RedBlackTreeCOW<Element>.Index.validate(left, right))
...
extension RedBlackTreeCOW {
    ...
    public struct Iterator: IteratorProtocol {
        let tree: RedBlackTreeCOW
        var index: RedBlackTreeCOW.Index
        
        init(_ tree: RedBlackTreeCOW) {
            self.tree = tree
